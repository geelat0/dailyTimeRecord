...
<template>
    <div :class="[isMobile ? 'flex flex-col gap-4' : 'flex flex-col gap-8']">
        <Container class="flex flex-col" header-text="Add Approved Attendance or Absence">
            <template #header>
                    <div class="">
                        <div v-for="(range, index) in dateRanges" 
                            ...
                            <div :class="[isMobile ? 'flex flex-col gap-4' : 'flex justify-between items-center gap-4']">
